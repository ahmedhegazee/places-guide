...
class DiscountController extends Controller
{
    ...
    {
        $records = Discount::with('place')->paginate(10);
        // dd($records);
        return view('cpanel.discounts.index', compact('records'));
    }
    ...
    //     return view('cpanel.discounts.create');
    // }
    ...
    {
        return view('cpanel.discounts.show', compact('discount'));
    }
    ...
    //     return view('cpanel.discounts.edit', compact('discount', 'categories'));
    // }
