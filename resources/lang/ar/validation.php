...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'messgAddres'=>'عنوان الرسالة',
        'work_category_id'=>'تصنيف العمال',
        'quantity'=>'العدد',
        'file'=>'الملف',
        'instagram'=>'صفحة انستجرام',
        'youtube'=>'قناة اليوتيوب',
        'twitter'=>'صفحة تويتر',
        'facebook'=>'صفحة الفيس بوك',
        'website'=>'الموقع',
        'end_date'=>'تاريخ نهاية الخصم',
        'starting_date'=>'تاريخ بداية الخصم',
        'discoutn'=>'الخصم',
        'rating'=>'التقييم',
        'closed_time'=>'وقت غلق الشركة',
        'opened_time'=>'وقت فتح الشركة',
        'category_id'=>'التصنيف',
        'city_id'=>'المدينة',
        'phone'=>'جوال',
