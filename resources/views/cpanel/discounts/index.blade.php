        ...
        <table id="table" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                ...
                <tr id="record-{{ $record->id }}">
                    ...
                    <td>
                        <a href="{{route('dashboard.discount.show',['discount'=>$record->id])}}"
                    ...
                    <td>
                        <a href="{{route('dashboard.discount.destroy',['discount'=>$record->id])}}"
                            id="delete-route-{{ $record->id }}"
                            onclick="event.preventDefault();deleteRecord({{ $record->id }});" class="btn btn-danger"><i
