...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('pages.List Of').' '. __('pages.Company Videos') }}</h3>
                ...
                <tbody>
                    ...
                    <tr id="record-{{ $record->id }}">
                        ...
                        <td><video playsinline="playsinline" width="200px" height="200px" src={{ $record->src }}
                                controls> </video></td>
                        <td>
                            <a href="{{route('video.show',['video'=>$record->id])}}" class="btn btn-primary"><i
                                    class="fas fa-eye"></i></a>
                        </td>
                        <td>
                            <a href="{{route('video.edit',['video'=>$record->id])}}" class="btn btn-success"><i
                                    class="fas fa-edit"></i></a>
                        </td>
                        <td>
                            <a href="{{route('video.destroy',['video'=>$record->id])}}"
